...
public:
    ...
    const EbNetworkAdapter* GetNetworkAdapter( uint32_t aIndex ) const;
    PtResult SetDriverEnabled( const EbNetworkAdapter* aNetworkAdapter, bool aEnabled = true );
    PtResult GetDriverEnabled ( const EbNetworkAdapter* aNetworkAdapter, bool& aEnabled ) const;       
