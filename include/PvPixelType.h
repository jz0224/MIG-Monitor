...
typedef enum 
{
    ...
    PvPixelMono10p =                 ( PVPIXELMONO  | PVPIXEL10BIT  | 0x0046 ), // PFNC 1.1
    PvPixelMono12p =                 ( PVPIXELMONO  | PVPIXEL12BIT  | 0x0047 ), // PFNC 1.1
    PvPixelBayerGR10p =              ( PVPIXELMONO  | PVPIXEL10BIT  | 0x0056 ), // PFNC 1.1
    PvPixelBayerRG10p =              ( PVPIXELMONO  | PVPIXEL10BIT  | 0x0058 ), // PFNC 1.1
    PvPixelBayerGB10p =              ( PVPIXELMONO  | PVPIXEL10BIT  | 0x0054 ), // PFNC 1.1
    PvPixelBayerBG10p =              ( PVPIXELMONO  | PVPIXEL10BIT  | 0x0052 ), // PFNC 1.1
    PvPixelBayerGR12p =              ( PVPIXELMONO  | PVPIXEL12BIT  | 0x0057 ), // PFNC 1.1
    PvPixelBayerRG12p =              ( PVPIXELMONO  | PVPIXEL12BIT  | 0x0059 ), // PFNC 1.1
    PvPixelBayerGB12p =              ( PVPIXELMONO  | PVPIXEL12BIT  | 0x0055 ), // PFNC 1.1
    PvPixelBayerBG12p =              ( PVPIXELMONO  | PVPIXEL12BIT  | 0x0053 ), // PFNC 1.1
